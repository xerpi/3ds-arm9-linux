 ...
 *
 *  $Id: 21285.c 573 2006-02-20 17:09:11Z stsp2 $
 */
...
static int __init serial21285_init(void)
{
	...
	printk(KERN_INFO "Serial: 21285 driver $Revision: 573 $\n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Intel Footbridge (21285) serial driver $Revision: 573 $");
