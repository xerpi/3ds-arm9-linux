...
/* $Id: applicom.c 573 2006-02-20 17:09:11Z stsp2 $			     */
...
int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c 573 2006-02-20 17:09:11Z stsp2 $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 573 $)\n");
