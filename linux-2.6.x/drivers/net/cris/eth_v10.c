/* $Id: eth_v10.c 573 2006-02-20 17:09:11Z stsp2 $
 *
 ...
 *
 * $Log$
 * Revision 1.2  2006/02/20 15:53:33  stsp2
 ...
 *
 * Revision 1.1.2.1  2006/02/18 13:54:14  stsp2
...
e100_ethtool_ioctl(struct net_device *dev, struct ifreq *ifr)
{
	...
	switch (ecmd.cmd) {
		...
		case ETHTOOL_GDRVINFO:
		{
			...
			strncpy(info.version, "$Revision: 573 $", sizeof(info.version) - 1);
