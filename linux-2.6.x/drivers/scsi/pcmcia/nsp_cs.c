...
/* $Id: nsp_cs.c 573 2006-02-20 17:09:11Z stsp2 $ */
...
MODULE_DESCRIPTION("WorkBit NinjaSCSI-3 / NinjaSCSI-32Bi(16bit) PCMCIA SCSI host adapter module $Revision: 573 $");
...
static struct Scsi_Host *nsp_detect(Scsi_Host_Template *sht)
{
	...
	snprintf(data->nspinfo,
		 sizeof(data->nspinfo),
		 "NinjaSCSI-3/32Bi Driver $Revision: 573 $ IO:0x%04lx-0x%04lx MMIO(virt addr):0x%04lx IRQ:%02d",
	...
	int    inout)
{
	...
	SPRINTF("Driver version:        $Revision: 573 $\n");
