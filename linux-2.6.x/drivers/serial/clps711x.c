 ...
 *
 *  $Id: clps711x.c 573 2006-02-20 17:09:11Z stsp2 $
 *
 */
...
static int __init clps711xuart_init(void)
{
	...
	printk(KERN_INFO "Serial: CLPS711x driver $Revision: 573 $\n");
...
MODULE_DESCRIPTION("CLPS-711x generic serial driver $Revision: 573 $");
MODULE_LICENSE("GPL");
