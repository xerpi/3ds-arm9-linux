 ...
 *
 *  $Id: sa1100.c 573 2006-02-20 17:09:11Z stsp2 $
 *
 */
...
static int __init sa1100_serial_init(void)
{
	...
	printk(KERN_INFO "Serial: SA11x0 driver $Revision: 573 $\n");
...
MODULE_DESCRIPTION("SA1100 generic serial port driver $Revision: 573 $");
MODULE_LICENSE("GPL");
